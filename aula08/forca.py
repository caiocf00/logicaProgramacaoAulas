...
def escolher_palavras():
    palavras = ['python', 'developer', 'programação', 'Inteligencia artificial','algoritmo', 'computador', 'desenvolvimento', 'tecnologia', 'software', 'hardware',
            'garoto  de programa', 'menina de programa', 'mulher de programa', 'homem de programa', 'disco', 'gabinete']
